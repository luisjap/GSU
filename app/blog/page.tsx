...
export const metadata: Metadata = {
  ...
  description: 'Contenido técnico sobre ingeniería eléctrica, climatización, sistemas hidráulicos y mantenimiento integral.',
};
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {BLOG_POSTS.map((post) => (
            <Link
              key={post.slug}
              href={`/blog/${post.slug}`}
              className="group flex flex-col rounded-2xl bg-[#E8ECEF] border border-black/[0.05] p-7 hover:bg-white hover:shadow-lg hover:shadow-black/[0.05] transition-all duration-300"
            >
